...
namespace Pokedex\Apps\Web\Backend\Command\DomainEvents\RabbitMq;
...
final class GenerateSupervisorRabbitMqConsumerFilesCommand extends Command
{
    ...
    private function template(): string
    {
        return <<<EOF
            ...
            command      = {path}/apps/web/backend/bin/console pokedex:domain-events:rabbitmq:consume --env=prod {queue_name} {events_to_process}
