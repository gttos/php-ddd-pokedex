...
namespace Pokedex\Apps\Mooc\Backend\Command\DomainEvents\RabbitMq;
...
final class GenerateSupervisorRabbitMqConsumerFilesCommand extends Command
{
    ...
    {
        return <<<EOF
            [program:pokedex_{queue_name}]
            command      = {path}/apps/mooc/backend/bin/console pokedex:domain-events:rabbitmq:consume --env=prod {queue_name} {events_to_process}
